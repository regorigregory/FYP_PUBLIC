...
def get_patch_absolute_difference_de_maetzu(currentIndex,
    ...
    modulus_left = (gcl[startRow:endRow, img1_start_column:img1_end_column] / gcl.max()) * 255
    modulus_right = (gcr[startRow:endRow, img2_start_column:img2_end_column] / gcr.max()) * 255

    phase_left = (pl[startRow:endRow, img1_start_column:img1_end_column] / pl.max()) * 255
    phase_right = (pr[startRow:endRow, img2_start_column:img2_end_column] / pr.max()) * 255
