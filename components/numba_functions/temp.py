...
def match_images(match, gap, egap,
    ...
    gcl = cf.calculate_gradients_sobel(im1_padded)
    gcr = cf.calculate_gradients_sobel(im2_padded)
...
if __name__ == "__main__":
    if __name__ == "__main__":
        ...
        x, z = test_pipeline(match, gap, egap, im1, im2, filter=filter,
                             gamma_c=1.61728984e+00,
                             gamma_s=2.58413081e+00,
                             alpha=8.94456111e-01,
                             T_c=3.21614357e-01,
                             T_s=5.22600291e-03)
