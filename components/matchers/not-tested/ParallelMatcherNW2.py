...
class Wrapper(ParallelMatcher, SequentialMatcher, Matcher):
    ...
    def __init__(self, match, gap, egap, initIndex=0, dmax=64):
        self.match = match
        self.gap = gap
        self.egap = egap
        self.matrices = None
        self.initFunctions = [self.maclean_init, self.fillUpFirstRows1, self.fillUpFirstRows2, self.fillUpFirstRows3]
        self.dmax = dmax
    ...
    def initializeMatrixTemplateOld(self, s1, s2):
